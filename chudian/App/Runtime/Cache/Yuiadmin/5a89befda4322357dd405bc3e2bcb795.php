...
<div class="layui-layout layui-layout-admin">
    ...
    <ul class="layui-nav layui-layout-right">
		...
		<li class="layui-nav-item"><a href="javascript:;" class="out_user" >退了</a></li>
    </ul>
  </div>
...
<script>
    ...
    $('.out_user').click(function() {
        layer.confirm('是否退出Layui后台', {
          btn: ['确定','取消'] //按钮
        }, function(){
          $.get(
            '/admin.php/Index/out_user', 
            function(data, textStatus, xhr) {
              if(data == 1){
                layer.msg('退出成功',{time:500});
                // window.location.href="http://www.ceshi.com/chudian/admin.php/Login/login";
                window.location.href="<?php echo U('Login/login');?>";
              }
          });
        }, function(){
            layer.msg('取消',{time:500});
        });
    });
